    ...
    <div id="rock-paper-scissors" className={styles.rockpaperscissors}>
      <div>
        <nav className="d-flex pt-3 ms-4">
          ...
          <div id="total-score" className={styles.totalscore + " ms-4"}>
      ...
      <section id="game-rps" className={styles.gamerps}>
        <div className="container">
          <div className="row">
            <div className="col-4 player-1  d-flex justify-content-center">
              <ul className="player-wrapper">
                ...
                {/* </Link> */}
                <li
                  className={`rock ${styles.choice} ` + getPickStyle("rock")}
                ...
                <li
                  className={`paper ${styles.choice} ${getPickStyle("paper")}`}
                ...
                <li
                  className={`scissors ${styles.choice} ${getPickStyle(
                    "scissors"
                  )}`}
            ...
            <div
              id="result"
              className={styles.result + " col-4 d-flex justify-content-center"}
            >
            ...
            <div className="col-4 com d-flex justify-content-center">
              <ul className="computer-wrapper">
                ...
                <li
                  id="com_rock"
                  className={`rock ${getComPickStyle("com_rock")}`}
                >
                  <img
                    src="../../assets/images/batu.png"
                    className="image-fluid"
                ...
                <li
                  id="com_paper"
                  className={`paper ${getComPickStyle("com_paper")}`}
                >
                  <img
                    src="../../assets/images/kertas.png"
                    className="image-fluid"
                ...
                <li
                  id="com_scissors"
                  className={`scissors ${getComPickStyle("com_scissors")}`}
                >
                  <img
                    src="../../assets/images/gunting.png"
                    className="image-fluid"
          ...
          <div
            id="reset"
            className="reset d-flex justify-content-center choice"
            onClick={handleReset}
          >
