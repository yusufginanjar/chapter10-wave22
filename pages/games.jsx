          ...
          <div className="col-md-6">
            <div className="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
              <div className="col p-4 d-flex flex-column position-static text-white">
                ...
                <p className="card-text mb-auto mt-2">
                  Traditional Game: Play vs AI
                </p>
                <div className="d-flex justify-content-between">
                  <Link href="/game/rps" className="stretched-link">
                    Play Now
                  </Link>
                </div>
              </div>
            ...
            <div className="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
              <div className="col p-4 d-flex flex-column position-static text-white">
                <strong className="d-inline-block mb-2 text-success">
                  Game {games.portal2.played == true ? "(Played)" : ""}
                </strong>
            ...
            <div className="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
              <div className="col p-4 d-flex flex-column position-static text-white">
                ...
                <div className="d-flex justify-content-between">
                  <a
                    href="#"
                    onClick={() => dispatch(playMario())}
                    className="stretched-link"
                  >
                    Play Now
                  </a>
                  {games.mario.played == true ? (
                    <p>Your score: {games.mario.score}</p>
                  ) : (
                    ""
                  )}
                </div>
